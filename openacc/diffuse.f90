...
!$acc enter data  & 
!$acc copyin(chunks(1)%field%density)  &
!$acc copyin(chunks(1)%field%energy0)  &
!$acc copyin(chunks(1)%field%energy1)  &
!$acc copyin(chunks(1)%field%u)  &
!$acc copyin(chunks(1)%field%u0)  &
!$acc copyin(chunks(1)%field%vector_p)  &
!$acc copyin(chunks(1)%field%vector_r)  &
!$acc copyin(chunks(1)%field%vector_Mi)  &
!$acc copyin(chunks(1)%field%vector_w)  &
!$acc copyin(chunks(1)%field%vector_z)  &
!$acc copyin(chunks(1)%field%vector_Kx)  &
!$acc copyin(chunks(1)%field%vector_Ky)  &
!$acc copyin(chunks(1)%field%vector_sd)  &
...
!$acc exit data  & 
!$acc copyout(chunks(1)%field%density)  &
!$acc copyout(chunks(1)%field%energy0)  &
!$acc copyout(chunks(1)%field%energy1)  &
!$acc copyout(chunks(1)%field%u)  &
!$acc copyout(chunks(1)%field%u0)  &
!$acc copyout(chunks(1)%field%vector_p)  &
!$acc copyout(chunks(1)%field%vector_r)  &
!$acc copyout(chunks(1)%field%vector_Mi)  &
!$acc copyout(chunks(1)%field%vector_w)  &
!$acc copyout(chunks(1)%field%vector_z)  &
!$acc copyout(chunks(1)%field%vector_Kx)  &
!$acc copyout(chunks(1)%field%vector_Ky)  &
!$acc copyout(chunks(1)%field%vector_sd)  &
!$acc copyout(chunks(1)%field%cellx)  &
!$acc copyout(chunks(1)%field%celly)  &
!$acc copyout(chunks(1)%field%vertexx)  &
!$acc copyout(chunks(1)%field%vertexy)  &
!$acc copyout(chunks(1)%field%celldx)  &
!$acc copyout(chunks(1)%field%celldy)  &
!$acc copyout(chunks(1)%field%vertexdx)  &
!$acc copyout(chunks(1)%field%vertexdy)  &
!$acc copyout(chunks(1)%field%volume)  &
!$acc copyout(chunks(1)%field%xarea)  &
!$acc copyout(chunks(1)%field%yarea)  
